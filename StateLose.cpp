	...
	, m_pImageHandler(pOwner->GetGame()->GetImageHandler())
{
	...
	// Add replay button, set callback, and add to gameObject vector
...
//////////////////////
// Renders this scene
void StateLose::Render(SDL_Renderer* pRenderer)
{
...
bool StateLose::HandleEvent(SDL_Event* pEvent)
{
	switch (pEvent->type)
	{
...
void StateLose::ChangeButtonFocus(int direction)
{
